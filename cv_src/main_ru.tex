...
\section{Опыт работы}
    \begin{twocolentry}{Июль 2023 – н. в.}
        ...
        \begin{highlights}
            ...
            \item Реализовал CI-пайплайна с использованием GitHub Actions для проектов лаборатории
        \end{highlights}
    \end{twocolentry}
...
\section{Проекты}
    \begin{twocolentry}{\href{https://github.com/robotics-laboratory/handy}{GitHub}}
        ...
        \begin{highlights}
            ...
            \item Разработал пайплайна для получения и синхронизации изображений с высокочастотныхтных камер и
