...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                ...
                \item Implemented efficient inference of detection and segmentation models with TorchScript
            \end{highlights}
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{TouchAndGo}
            \begin{highlights}  
                \item High school graduation project aimed at helping visually impaired individuals navigate
    ...
    \section{Teaching}
        \begin{twocolentry}{
            ...
            \textbf{HSE Lyceum}, Computer Science Teacher (C++, Algorithms and Data Structures)
                \begin{highlights}
